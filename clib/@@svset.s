 TITLE '/home/mike/repos/crent370/clib/@@svset.c'
         COPY  PDPTOP
         CSECT
...
* Program text area
         DS    0F
         EJECT
* external function 'ssvt_set' prologue
...
@@L6     EQU   *
@@L1     EQU   *
* Function 'ssvt_set' epilogue
         PDPEPIL
* Function 'ssvt_set' literal pool
         DS    0D
         LTORG
* Function 'ssvt_set' page table
@@PGT0   DS    0F
         DC    A(@@PG0)
         END
