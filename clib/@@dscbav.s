 TITLE '/home/mike/repos/crent370/clib/@@dscbav.c'
         COPY  PDPTOP
         CSECT
...
* Program text area
         DS    0F
         EJECT
* external function '__dscbav' prologue
...
* Function '__dscbav' code
         ...
         BALR  14,15
         MVI   134(13),0 ==> volser
         MVC   104(4,13),=F'-1065353216' ==> .flags
         ST    3,108(13) ==> .p1
         ST    2,112(13) ==> .p2
         MVC   116(4,13),8(11) ==> .p3,dscb
         LA    2,104(,13)
         LR    1,2
         SVC   27    OBTAIN
         LR    2,15 ==> rc
