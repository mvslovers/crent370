 TITLE '/home/mike/repos/crent370/crypto/bfishdec.c'
         COPY  PDPTOP
         CSECT
...
* Program text area
         DS    0F
         EJECT
* external function 'blowfish_decrypt' prologue
* frame base=88, local stack=0, call args=0
&FUNC    SETC  'blowfish_decrypt'
BFISHDEC PDPPRLG CINDEX=0,FRAME=88,BASER=12,ENTRY=YES
         B     @@FEN0
         LTORG
@@FEN0   EQU   *
         DROP  12
...
@@PG0    EQU   *
         LR    11,1
         L     10,=A(@@PGT0)
* Function 'blowfish_decrypt' code
         L     3,0(11) ==> in
         L     5,4(11) ==> out
         L     4,8(11) ==> keystruct
         IC    15,0(3) ==> in
         ...
         STC   2,6(5)
         STC   6,7(5) ==> r
* Function 'blowfish_decrypt' epilogue
         PDPEPIL
* Function 'blowfish_decrypt' literal pool
         DS    0D
         LTORG
* Function 'blowfish_decrypt' page table
@@PGT0   DS    0F
         DC    A(@@PG0)
         END
