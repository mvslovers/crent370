 TITLE '/home/mike/repos/crent370/time64/tm64ugmt.c'
         COPY  PDPTOP
         CSECT
...
* Program text area
         DS    0F
         EJECT
* external function 'ugmtime64' prologue
* frame base=88, local stack=8, call args=16
&FUNC    SETC  'ugmtime64'
TM64UGMT PDPPRLG CINDEX=0,FRAME=112,BASER=12,ENTRY=YES
         B     @@FEN0
         LTORG
@@FEN0   EQU   *
         DROP  12
...
* Function 'ugmtime64' code
         ...
         L     15,=V(TM64GMTR)
         BALR  14,15
* Function 'ugmtime64' epilogue
         PDPEPIL
* Function 'ugmtime64' literal pool
         DS    0D
         LTORG
* Function 'ugmtime64' page table
@@PGT0   DS    0F
         DC    A(@@PG0)
         END
