 TITLE '/home/mike/repos/crent370/time64/tm64ucti.c'
         COPY  PDPTOP
         CSECT
...
* Program text area
         DS    0F
         EJECT
* external function 'uctime64' prologue
* frame base=88, local stack=8, call args=16
&FUNC    SETC  'uctime64'
TM64UCTI PDPPRLG CINDEX=0,FRAME=112,BASER=12,ENTRY=YES
         B     @@FEN0
         LTORG
@@FEN0   EQU   *
         DROP  12
...
@@PG0    EQU   *
         LR    11,1
         L     10,=A(@@PGT0)
* Function 'uctime64' code
         MVC   88(4,13),0(11) ==> utime
         ...
         L     15,=V(TM64ASC)
         BALR  14,15
* Function 'uctime64' epilogue
         PDPEPIL
* Function 'uctime64' literal pool
         DS    0D
         LTORG
* Function 'uctime64' page table
@@PGT0   DS    0F
         DC    A(@@PG0)
         END
