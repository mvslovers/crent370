 TITLE '/home/mike/repos/crent370/time64/tm64mcti.c'
         COPY  PDPTOP
         CSECT
...
* Program text area
         DS    0F
         EJECT
* external function 'mctime64' prologue
...
@@PG0    EQU   *
         LR    11,1
         L     10,=A(@@PGT0)
* Function 'mctime64' code
         MVC   88(4,13),0(11) ==> mtime
         MVC   92(4,13),=F'1000'
         LA    2,104(,13)
         ST    2,96(13)
         LA    1,88(,13)
         ...
         L     15,=V(TM64ASC)
         BALR  14,15
* Function 'mctime64' epilogue
         PDPEPIL
* Function 'mctime64' literal pool
         DS    0D
         LTORG
* Function 'mctime64' page table
@@PGT0   DS    0F
         DC    A(@@PG0)
         END
