 TITLE '/home/mike/repos/crent370/time64/tm64ltm.c'
         COPY  PDPTOP
         CSECT
...
* Program text area
         DS    0F
         EJECT
* external function 'localtime64' prologue
* frame base=88, local stack=0, call args=8
&FUNC    SETC  'localtime64'
...
@@PG0    EQU   *
         LR    11,1
         L     10,=A(@@PGT0)
* Function 'localtime64' code
         LA    1,88(,13)
         L     15,=V(@@CRTGET)
         BALR  14,15
         A     15,=F'296' ==> tms
         MVC   88(4,13),0(11) ==> timer
         ST    15,92(13) ==> tms
         LA    1,88(,13)
         L     15,=V(TM64LTMR)
         BALR  14,15
* Function 'localtime64' epilogue
         PDPEPIL
* Function 'localtime64' literal pool
         DS    0D
         LTORG
* Function 'localtime64' page table
@@PGT0   DS    0F
         DC    A(@@PG0)
         END
