 TITLE '/home/mike/repos/crent370/time64/tm64mltm.c'
         COPY  PDPTOP
         CSECT
...
* Program text area
         DS    0F
         EJECT
* external function 'mlocaltime64' prologue
* frame base=88, local stack=8, call args=16
&FUNC    SETC  'mlocaltime64'
...
* Function 'mlocaltime64' code
         ...
         L     15,=V(TM64LTMR)
         BALR  14,15
* Function 'mlocaltime64' epilogue
         PDPEPIL
* Function 'mlocaltime64' literal pool
         DS    0D
         LTORG
* Function 'mlocaltime64' page table
@@PGT0   DS    0F
         DC    A(@@PG0)
         END
