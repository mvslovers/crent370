 TITLE '/home/mike/repos/crent370/time64/tm64ctir.c'
         COPY  PDPTOP
         CSECT
...
* Program text area
         DS    0F
         EJECT
* external function 'ctime64_r' prologue
* frame base=88, local stack=40, call args=8
&FUNC    SETC  'ctime64_r'
...
@@L2     EQU   *
         LR    15,3 ==> result
* Function 'ctime64_r' epilogue
         PDPEPIL
* Function 'ctime64_r' literal pool
         DS    0D
         LTORG
* Function 'ctime64_r' page table
@@PGT0   DS    0F
         DC    A(@@PG0)
         END
