 TITLE '/home/mike/repos/crent370/time64/tm64mclk.c'
         COPY  PDPTOP
         CSECT
...
* Program text area
         DS    0F
         EJECT
* external function 'mclock64' prologue
...
@@L2     EQU   *
         ...
         LR    15,6
* Function 'mclock64' epilogue
         PDPEPIL
* Function 'mclock64' literal pool
         DS    0D
         LTORG
* Function 'mclock64' page table
@@PGT0   DS    0F
         DC    A(@@PG0)
         END
