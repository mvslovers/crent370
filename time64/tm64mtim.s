 TITLE '/home/mike/repos/crent370/time64/tm64mtim.c'
         COPY  PDPTOP
         CSECT
...
* Program text area
         DS    0F
         EJECT
* external function 'mtime64' prologue
...
* Function 'mtime64' code
         ...
         BE    @@L2
         ST    2,0(5) ==> tt,mtimer
         ST    3,4+0(5) ==> tt,mtimer
@@L2     EQU   *
         ST    2,0(4) ==> tt,<result>
         ST    3,4+0(4) ==> tt,<result>
         LR    15,4
* Function 'mtime64' epilogue
         PDPEPIL
* Function 'mtime64' literal pool
         DS    0D
         LTORG
* Function 'mtime64' page table
@@PGT0   DS    0F
         DC    A(@@PG0)
         END
