 TITLE '/home/mike/repos/crent370/time64/tm64gmt.c'
         COPY  PDPTOP
         CSECT
...
* Program text area
         DS    0F
         EJECT
* external function 'gmtime64' prologue
...
* Function 'gmtime64' code
         ...
         L     15,=V(TM64GMTR)
         BALR  14,15
* Function 'gmtime64' epilogue
         PDPEPIL
* Function 'gmtime64' literal pool
         DS    0D
         LTORG
* Function 'gmtime64' page table
@@PGT0   DS    0F
         DC    A(@@PG0)
         END
