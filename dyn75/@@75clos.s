 TITLE '/home/mike/repos/crent370/dyn75/@@75clos.c'
         COPY  PDPTOP
         CSECT
...
* Program text area
         DS    0F
         EJECT
* external function 'closesocket' prologue
...
* Function 'closesocket' code
         ...
         BALR  14,15
         SLR   15,15
* Function 'closesocket' epilogue
         PDPEPIL
* Function 'closesocket' literal pool
         DS    0D
         LTORG
* Function 'closesocket' page table
@@PGT0   DS    0F
         DC    A(@@PG0)
         END
