 TITLE '/home/mike/repos/crent370/dyn75/@@75snam.c'
         COPY  PDPTOP
         CSECT
...
* Program text area
         DS    0F
         EJECT
* external function 'getsockname' prologue
* frame base=88, local stack=72, call args=16
&FUNC    SETC  'getsockname'
@@75SNAM PDPPRLG CINDEX=0,FRAME=176,BASER=12,ENTRY=YES
         B     @@FEN0
         LTORG
@@FEN0   EQU   *
         DROP  12
...
@@L10    EQU   *
         LR    15,4 ==> rc
* Function 'getsockname' epilogue
         PDPEPIL
* Function 'getsockname' literal pool
         DS    0D
         LTORG
* Function 'getsockname' page table
@@PGT0   DS    0F
         DC    A(@@PG0)
@@LC0    EQU   *
         DC    X'0'
